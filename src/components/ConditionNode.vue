<template>
<div
  class="px-4 py-4 shadow-md rounded-md bg-white border-2 transition-all duration-200 relative"
  :class="[
...
// This computed property tracks the simulation progress - optimized to only track active state
